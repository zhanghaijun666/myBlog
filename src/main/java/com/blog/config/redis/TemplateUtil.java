...
public class TemplateUtil {
    ...
    public void setRedisTemplate(RedisTemplate<String, Object> redisTemplate) {
        this.setRedisTemplate(redisTemplate, 1);
    }

    public void setRedisTemplate(RedisTemplate<String, Object> redisTemplate, int index) {
        if (redisTemplate.getConnectionFactory() instanceof LettuceConnectionFactory) {
            ...
            redisConnectionFactory.getClusterConnection().select(index);
            redisTemplate.setConnectionFactory(redisConnectionFactory);
        }
